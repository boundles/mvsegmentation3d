...
class TrilinearDevoxelization(Function):
    ...
    def forward(ctx, features, coords, resolution, is_training=True):
        ...
        outs, inds, wgts = devoxelization_ext.trilinear_devoxelize_forward(resolution, is_training, coords, features)
        if is_training:
    ...
    def backward(ctx, grad_output):
        ...
        grad_inputs = devoxelization_ext.trilinear_devoxelize_backward(grad_output.contiguous(), inds, wgts, ctx.r)
