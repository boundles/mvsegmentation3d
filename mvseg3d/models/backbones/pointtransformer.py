...
from mvseg3d.models.layers import PointTransformerBlock, TransitionDown, TransitionUp
...
class PointTransformer(nn.Module):
    def __init__(self, in_channel):
        ...
        self.in_planes, planes, share_planes = self.in_c, [32, 64, 128, 256, 512], 8
        stride, nsample = [1, 2, 2, 4, 2], [16, 16, 16, 16, 16]
